								...
								[{
									...
									validate : function ()
									{
										if ( this.isEnabled() )
										{
											if ( !this.getValue() )
											{
												alert('Вы должны ввести HTML-код или адрес');
												return false;
											}
											else
											if ( this.getValue().length === 0 || this.getValue().indexOf( '//' ) === -1 )
											{
												alert('Ваш HTML-код не похож на правильный');
												return false;
											}
										}
									}
									...
									[
										{
											id : 'txtUrl',
											type : 'text',
											label : 'Вставьте адрес видео (URL)',
											onKeyUp : function ( api )
											{
												if ( this.getValue().length > 0 )
												{
											...
											validate : function ()
											{
												if ( this.isEnabled() )
												{
													if ( !this.getValue() )
													{
														...
														{
															alert('Ваш адрес видео не похож на правильный');
															return false;
														}
													}
												}
										...
										},
										{
											...
											validate : function ()
											{
												if ( this.getValue() )
												{
													...
													if ( width === 0 )
													{
														alert('Укажите правильную ширину');
														return false;	
													}
												}
												else {
													alert('Вы должны указать ширину');
													return false;
												}
											}
										},
										{
											...
											validate : function ()
											{
												if ( this.getValue() )
												{
													...
													if ( height === 0 )
													{
														alert('Укажите правильную высоту');
														return false;	
													}
												}
												else {
													alert('Вы должны указать высоту');
													return false;
												}
											}
										}
									...
									[
										{
											...
											label : 'Показать похожие видео после завершения просмотра'
										},
										{
											id : 'chkOlderCode',
											type : 'checkbox',
											'default' : editor.config.youtube_older != null ? editor.config.youtube_older : false,
											label : 'Использовать старый код вставки'
										}
									]
								},
								{
									...
									[
										{
											id : 'chkPrivacy',
											type : 'checkbox',
											label : 'Включить режим повышенной конфиденциальности',
											'default' : editor.config.youtube_privacy != null ? editor.config.youtube_privacy : false
										},
										{
											id : 'txtStartAt',
											type : 'text',
											label : 'Начать с (сс или мм:сс или чч:мм:сс)',
											validate : function ()
											{
												if ( this.getValue() )
												{
													...
													{
														alert('Укажите правильное время начала');
														return false;
													}
												}
											}
